        ...
        <main v-else class="page-list">
            ...
            <div class="level-container">
                <div class="level" v-if="level">
                    <h1>{{ level.name }}</h1>
                    <LevelAuthors :author="level.author" :Creadores="level.creators" :verifier="level.verifier"></LevelAuthors>
                    ...
                    <ul class="stats">
                        ...
                        <li>
                            <div class="type-title-sm">Tonto Scale</div>
                            <p>{{ level.tontoscale || '0' }}</p>
                        </li>
                    </ul>
                    <h2>Records</h2>
